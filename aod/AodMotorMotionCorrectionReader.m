...
classdef AodMotorMotionCorrectionReader < HDF5Helper    
    methods 
        function self = AodMotorMotionCorrectionReader(filename)
            %self.restrict()
            self = self@HDF5Helper(filename, 'MotorMotionCorrectionData');
        end
